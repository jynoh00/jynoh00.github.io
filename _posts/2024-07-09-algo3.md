...
- DFS와 BFS의 구현을 하기 위해선 <a href = "/data-structure/2024/07/08/ds1.html">스택(Stack)</a>과 <a href = "/data-structure/2024/07/08/ds2.html">큐(Queue)</a>, 재귀함수, 그래프에 대한 이해가 우선으로 필요하다.
